...
object ConditionPresetV2 {
    ...
    val m11_cond = C(MT.PLAYER_PROGRESS_KILL, MTA.MINE_MODULE, listOf(1), goal = 40)
    val m12_cond = C(MT.MODULE_PLACE, MTA.STORAGE_MODULE, listOf(1))
    val m13_cond = C(MT.PLAYER_EP, MTA.EP, listOf(1))
    val m14_cond = C(MT.PLAYER_PROGRESS, MTA.MINE_MODULE, listOf(1), goal = 200)
    val m15_cond = C(MT.PLAYER_PROGRESS_KILL, MTA.MINE_MODULE, listOf(1), goal = 70)
